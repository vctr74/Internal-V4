...
namespace ImGui
{
    ...
    // NEW
    bool ButtonExx( const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags );
    bool ButtonNew( const char* label, const ImVec2& size_arg );
    ...
    IMGUI_API bool          ColorEdit4(const char* label, float col[4], ImGuiColorEditFlags flags = 0, const char* txt = "Colour" );
